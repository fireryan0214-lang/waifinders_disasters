...
if audit:
    ...
    audit_card = f"<section class='card'><h2>Earthquake pipeline coverage</h2><p><b>{metric['earthquakes_received']}</b> earthquakes fully exercised<br><b>{metric['earthquakes_with_customer_asset_matches']}</b> with customer-asset matches<br><b>{metric['public_context_lookups_succeeded']}</b> public-context lookups succeeded<br><b>{metric['public_context_lookups_failed']}</b> public-context lookups failed</p><p class='subtitle'>This is a coverage audit, not an incident queue. Source-only records reveal missing infrastructure data or public lookup reliability gaps.</p></section>"
